...
const Content = () => (
	<div className={styles['about-content_container']}>
		<p>
			A passion for coding, and web development with a thrive to develop powerful content. Experienced in UX/UI design using a range of front-end and back-end skills. A database expert, full stack skill set, who knows how to contruct a single-page application.
		</p>
		<p>
